...
import { FaHome, FaCalendarAlt, FaUserMd, FaUsers, FaClock, FaSignOutAlt, FaList, FaChartBar, FaUserTie, FaIdCard } from 'react-icons/fa';
...
const Sidebar = () => {
  ...
  const navItems = [
    ...
    { path: '/admin/calendar', icon: FaClock, label: 'Calendar' },
    { path: '/admin/services', icon: FaList, label: 'Services' },
    { path: '/admin/profile', icon: FaIdCard, label: 'Profile' },
  ];
